...
// FIX: Use a named import for the ChatMessage type.
import { ChatMessage } from '../types';
import { getChatbotResponse, createChat } from '../services/geminiService';
import { Chat } from '@google/genai';
import LoadingDots from './LoadingDots';

const Chatbot: React.FC = () => {
    const [messages, setMessages] = useState<ChatMessage[]>([
        { role: 'model', parts: [{ text: "Hello! I'm your Pathshaala assistant. How can I help you today?" }] }
    ]);
    ...
    return (
        <div className="bg-white dark:bg-slate-800 rounded-lg shadow-xl p-6 h-full flex flex-col">
            <h2 className="text-3xl font-bold mb-4 text-slate-800 dark:text-white">Help Assistant</h2>
