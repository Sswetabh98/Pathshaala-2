...
interface PinResetPendingPageProps {
  onLogout: () => void;
}

const PinResetPendingPage: React.FC<PinResetPendingPageProps> = ({ onLogout }) => {
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-slate-100 to-gray-200 dark:from-slate-900 dark:to-gray-800">
      <div className="w-full max-w-md p-8 space-y-6 text-center bg-white rounded-2xl shadow-2xl dark:bg-slate-800">
        <svg className="w-24 h-24 mx-auto text-indigo-500" xmlns="http://www.w.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
        </svg>
        <h1 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-white">
          PIN Reset Pending Approval
        </h1>
        <p className="text-gray-600 dark:text-gray-400">
          Your new PIN has been submitted and is currently awaiting approval from an administrator.
        </p>
        <p className="text-sm text-gray-500 dark:text-gray-500">
          You will receive a notification once your new PIN has been approved. You can now log out.
        </p>
        <button
          onClick={onLogout}
...
export default PinResetPendingPage;
